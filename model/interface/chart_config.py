...
NZUPY_CHART_STYLE = {
    ...
    "colors": {
        ...
        # Semi-transparent versions (with 0.4 alpha)
        ...
        # Diverging palette — retained for future chart development
        ...
        # Reference lines
        "reference_primary": "rgb(47, 47, 47)",
        "reference_secondary": "rgb(108, 108, 108)",
        "reference_secondary_transparent": "rgba(108, 108, 108, 0.2)",

        # Auction volume colours
        "auction_volume_dark": "rgb(17, 17, 17)",
        "auction_volume_medium": "rgb(108, 108, 108)",
        "auction_volume_light": "rgb(169, 169, 169)",
    },
...
def get_band_colors(base_color: str) -> Dict[str, str]:
    ...
    return {
        'central': base_color,
        'std_error': create_uncertainty_color(
            base_color, NZUPY_CHART_STYLE["uncertainty_opacity"]["std_error"]
        ),
        'confidence': create_uncertainty_color(
            base_color, NZUPY_CHART_STYLE["uncertainty_opacity"]["confidence"]
        )
    }
